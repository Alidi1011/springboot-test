...
import org.aarteaga.test.springboot.app.exceptions.DineroInsuficienteException;
...
import static org.aarteaga.test.springboot.app.Datos.*;
...
class SpringbootTestApplicationTests {
	...
	@BeforeEach
	void setUp(){
		//cuentaRepository = mock(CuentaRepository.class); //FORMA TRADICIONAL
		//bancoRepository = mock(BancoRepository.class); //FORMA TRADICIONAL
		//service = new CuentaServiceImpl(cuentaRepository, bancoRepository); //FORMA TRADICIONAL
